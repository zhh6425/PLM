...
class Mask3D(nn.Module):
    def __init__(
        ...
        # self.iou_prediction_head = MLP(hidden_dim, 256, 1, 3)
    ...
    def get_backbone_feats(self, x):
        pcd_features, _ = self.backbone(x)
        return pcd_features.decomposed_features
    ...
    def forward(
        ...
        for decoder_counter in range(self.num_decoders):
            ...
            for i, hlevel in enumerate(self.hlevels):
                ...
                # predictions_iou.append(output_iou)

        if self.train_on_segments:
            output_class, outputs_mask, mask_embed = self.mask_module(
                queries,
                mask_features,
                mask_segments,
                0,
        ...
        return {
            ...
            "backbone_features": pcd_features.decomposed_features,
        }
    ...
    def mask_module(
        ...
        # outputs_iou = self.iou_prediction_head(query_feat)   
        output_masks = []
